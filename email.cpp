...
int mailer::sendEmail(QString dist, QString obj, QString bdy)
{
    ...
    qDebug()<<"supportsSsl: "<<QSslSocket::supportsSsl();; //oussema.bouabdallah1@gmail.com

    qDebug()<<QCoreApplication::libraryPaths();
    // SMTP server information
    QString smtpServer = "smtp.gmail.com";
    int smtpPort = 465;  // Adjust this based on your SMTP server configuration
    QString username = "dbwes23@gmail.com"; //
    QString password = "rqmp xxty hoqo vrdy"; // mdp d'application
    //opuc ifgh tjle ciag
    // Sender and recipient information
    QString from = "dbwes23@gmail.com";
    QString to =dist;
    QString subject = obj;
    QString body = bdy;
