...
gestfour::gestfour(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::gestfour)
...
//Ajouter
void gestfour::on_pb_ajouter_clicked()
{
...
//recherche
void gestfour::on_pb_recherche_clicked()
{
    Fournisseur Sp;
...
//suprrimer
void gestfour::on_pb_supp_clicked()
{
    Fournisseur Sp;
    Sp.set_ID(ui->lineEdit_id_sup->text().toInt());
    Sp.supprimer(Sp.get_ID());
    ui->tab_fournisseur->setModel(Sp.afficher());
    ui->lineEdit_id_sup->clear();
}
//modifier
void gestfour::on_pb_modifier_clicked()
{
    int ID=ui->lineEdit_ID->text().toInt();
    QString nom_fournisseur=ui->lineEdit_Nom->text();
    QString adresse=ui->lineEdit_Adr->text();
...
//new
void gestfour::on_actionNew_triggered()
{
    ui->lineEdit_ID->clear();
    ui->lineEdit_Nom->clear();
    ui->lineEdit_Adr->clear();
...
//exit
void gestfour::on_actionExit_triggered()
{
...
//Trier
void gestfour::on_radioButton_id_clicked()
{
    Fournisseur *Sp = new Fournisseur();
    ui->tab_fournisseur->setModel(Sp->tri_ID());
}

void gestfour::on_radioButton_nom_clicked()
{
    Fournisseur *Sp = new Fournisseur();
...
void gestfour::on_pb_PDF_clicked()
{
    QString strStream;
...
void gestfour::on_pb_STAT_clicked()
{
...
void gestfour::on_Search_button_clicked()
{
...
void gestfour::on_page_email_clicked()
{
...
void gestfour::on_Medicament_clicked()
{
...
void gestfour::on_client_clicked()
{
...
void gestfour::on_employer_clicked()
{
